...
declare -x GIO_LAUNCHED_DESKTOP_FILE_PID=1865
...
declare -x HOME=/home/knockla
declare -x IM_CONFIG_CHECK_ENV=1
declare -x IM_CONFIG_PHASE=1
declare -x INVOCATION_ID=a27c5cc995584379a5537e422cee4ef1
declare -x JOURNAL_STREAM=8:11030
...
declare -x MANAGERPID=1106
declare -x NO_AT_BRIDGE=1
declare -x OLDPWD=/home/knockla/Documents
declare -x ORIGINAL_XDG_CURRENT_DESKTOP=Unity
declare -x PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin
declare -x PWD=/home/knockla/Documents/minishelll
declare -x QT_ACCESSIBILITY=1
declare -x QT_IM_MODULE=ibus
declare -x SESSION_MANAGER=local/knocka-vm:@/tmp/.ICE-unix/1209,unix/knocka-vm:/tmp/.ICE-unix/1209
declare -x SHELL=/bin/bash
declare -x SHLVL=6
declare -x SSH_AGENT_LAUNCHER=gnome-keyring
declare -x SSH_AUTH_SOCK=/run/user/1000/keyring/ssh
declare -x SYSTEMD_EXEC_PID=1242
declare -x TERM=xterm-256color
declare -x TERM_PROGRAM=vscode
declare -x TERM_PROGRAM_VERSION=1.93.1
declare -x USER=knockla
declare -x USERNAME=knockla
...
declare -x VSCODE_GIT_IPC_HANDLE=/run/user/1000/vscode-git-46b4b960b7.sock
declare -x WAYLAND_DISPLAY=wayland-0
declare -x XAUTHORITY=/run/user/1000/.mutter-Xwaylandauth.UPJ0T2
